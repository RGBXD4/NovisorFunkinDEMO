...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Cinematic', "Value 1: On or Off\nOn - Turn On Cinematics\nOff - Turn Off Cinematics"],
		['Dark', "Value 1: On or Off\nOn - Turn On Dark\nOff - Turn Off Dark"],
		['Flash Camera', "Value 1: Set Duration"],
		['Set Cam Zoom', "Value 1: Cam Zoom\nValue 2: Instant Zoom"],
		["HUD Fade", "Value 1: fadein or fadeout\nfadein = Turn On HUD\nfadeout = Turn Off HUD"],
		["JustNotes", "Value 1: on or off\non = HUD\noff = No HUD"],
		['Lights', "Value 1: On or Off\nOn - Turn On Lights\nOff - Turn Off Lights"],
		['Static', "Value 1: On or Off\nOn - Turn On Static\nOff - Turn Off Static"]
	];
	...
	**/
	...
	function addEventsUI():Void
	{
		...
		directories.push(Paths.getPreloadPath(Paths.currentModDirectory + '/events/'));
		for(mod in Paths.getGlobalMods())
			directories.push(Paths.getPreloadPath(mod + '/events/'));
		#end
