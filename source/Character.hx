...
class Character extends FlxSprite
{
	...
	public var ghostTween:FlxTween;
	...
	public function playGhostAnim(?AnimPlay:String = "singLEFT", Force:Bool = false):Void {
		ghost.frames = frames;
		ghost.animation.copyFrom(animation);
		ghost.setPosition(x, y);
		ghost.animation.play(AnimPlay, Force);
		ghost.offset.set(animOffsets.get(AnimPlay)[0], animOffsets.get(AnimPlay)[1]);
		ghost.flipX = flipX;
		ghost.flipY = flipY; // placeholder
